...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, stride=1, downsample=None):   # downsample对应虚线残差结构捷径中的1×1卷积
        ...
        self.conv1 = common.slim_conv_3x3(in_channel, 1, 1, 1)
        self.bn1 = nn.BatchNorm2d(in_channel//4*3)
        self.relu = nn.ReLU()
        self.conv2 = nn.Conv2d(in_channels=in_channel//4*3, out_channels=out_channel,
...
class Netv3(nn.Module):
    def __init__(self, block, layers, num_classes=1):
        ...
        self.gau3 = common.AAM(filters[3], filters[3])  # RAUNet
        self.gau2 = common.AAM(filters[2], filters[2])
        self.gau1 = common.AAM(filters[1], filters[1])

        # Final Classifier
        self.finalconv1 = nn.Conv2d(64, 64, 1)
        self.finalrelu1 = nn.ReLU(inplace=True)
        self.finalconv2 = nn.Conv2d(64, num_classes, 1)
        self.ca = common.CA(1024,1024)
